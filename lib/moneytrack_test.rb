...
module MoneytrackTest
 ...
 {:signature=>
  ...
  test = [
    {
      :signature=>"18cc6d51e125e7ad11f37928bd5ff7e04c1ab27409180d552f9ce6db6050187",
      :header=>{
        :timestamp=>"2019-02-22T17:43:48Z",
        :previous_block=>nil,
  ...
  :payload=>{"hello"=>"world", "key1"=>"value1"}},
  {
    :signature=>"818b6aec352ee8cb7b4846cfbd3173a074ed9463fcc534cfbdda7af16aae6e19",
    :header=>{
      :timestamp=>"2019-04-14T15:47:23Z",
      :previous_block=>nil,
      :payload_signature=>"3a87af5e8ceb519b74e02a2cfde90a12faa34f0f9142b033e5338acab58b18e5"
      },
      :payload=>{"hello"=>"world", "key1"=>"value1"}
  ...
  begin
    IntegrityCheckService.new([]).perform
  rescue StandardError => e
    puts e.message
  end
  exit()
